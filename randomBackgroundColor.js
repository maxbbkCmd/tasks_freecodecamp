...
// 💛CamperBot закончил создание своего случайного сменщика цвета фона. Однако, когда они нажимают кнопку, цвет фона не меняется. Похоже, они пытаются использовать свойство onclick, но делают это неправильно. Свойству onclick следует назначить ссылку на функцию. Исправьте ошибку в строке btn.onclick = changeBackgroundColor();. Помните, что вы работали со свойством onclick в проекте ролевой игры. Посмотрите на окончательное решение, чтобы увидеть, как правильно использовался onclick. Как только вы исправите эту последнюю ошибку, случайный сменщик цвета фона будет готов!
